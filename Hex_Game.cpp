...
// HOW TO RUN THE PROGRAM: just compile and run this script. The terminal prompts will guide you
// in the settings process and will manage the game flow.

// ===========================
// Readme. About the Hex game:
// ===========================
// - Hex is a tic-tac-toe style game which consists in taking turns to try to connect the two borders
// of a board of hexagonal tiles. One player must try connect the top and bottom borders and the other
...
// =================================
// About the classes of this script:
// =================================
...
// - Hex_Game is the class that makes a game object. Such game object manages the game flow, does the
...
#include <iostream>
#include <vector>
#include <algorithm> // Without this, std::vector.find() wouldn't be supported
#include <random>
#include <fstream>
#include <iterator>
...
std::uniform_real_distribution<double> cost_value(0.0, 10.0); // Cost or distance values of the graphs will be between 0 and 10
...
namespace Graph{
    ...
    class Graph{
        ...
        public:
            ...
            int V(){ // Returns the number of vertices or nodes of the graph
                return size;
            }

            int E(){ // Returns the number of edges of the graph
                int count = 0;
                if(edgeList_was_computed==true){
                    for(int i=0; i<size; ++i){
            ...
            numType get_node_value(int i){ // Returns the value associated with the node i
                return nodeValues[i];
            }
            ...
            int get_node_tag(int i){ // Returns the tag of the node i
                return nodeTags[i];
            }
            ...
            numType get_edge_value(int nodeFrom, int nodeTo){ // Returns the value (the cost) associated to the edge from nodeFrom to nodeTo
                if(edgeList_was_computed==true){
    ...
    class Hex_Board : public undirected_Graph<int>{
        ...
        public:
            ...
            int coordinate_to_nodeIndex(int x, int y){
            ...
            pair<int, int> nodeIndex_to_coordinate(int index){
            ...
            int get_node_value_byCoordinates(int x, int y){
            ...
            int get_node_tag_byCoordinates(int x, int y){
    ...
    class Hex_Game{
        ...
        public:
            ...
            game_finished(false),who_won(0){ // Default constructor
                ...
                // }
                cout<<"Do you want to play versus computer? ---> FEATURE NOT AVAILABLE YET"<<endl;
                vs_robot = false;
                cout<<">> Player 2 will be a human.\n"<<endl;
                string aux2;
            ...
            void player_move_by_input(int player){
                ...
                if(this_is_movement_number==1 && swap_rule){
            ...
            void game_loop(){ // This is the loop which runs the game.
                ...
                board.draw_board_ASCII(false);
                // cout<<"\nHere is your game board. Press S + ENTER to start the game."<<endl;
                // string aux3;
                // cin>>aux3;

                if(vs_robot){
                    cout<<"TO DO: IMPLEMENTATION OF AUTOMATIC PLAYER (BOT OPPONENT). WILL BE IMPLEMENTED IN THE FUTURE."<<endl;
                }else{
...
int main(){
    ...
    cout<<"\n\nImplementation of Hex game. NOTICE: in this version you CAN'T use the bot opponent"<<endl;
    cout<<"(that feature will be implemented in a future version of the program)."<<endl;
    cout<<"Please, just play against a human for now."<<endl;

    cout<<"\n## Author: Angel Mateo Arenas"<<endl;
